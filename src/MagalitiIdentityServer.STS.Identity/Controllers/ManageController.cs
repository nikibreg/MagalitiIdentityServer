...
using MagalitiIdentityServer.STS.Identity.ViewModels.Manage;

namespace MagalitiIdentityServer.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MagalitiIdentityServer.STS.Identity"),
