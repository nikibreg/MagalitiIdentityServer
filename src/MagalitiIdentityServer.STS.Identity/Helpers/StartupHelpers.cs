...
using SendGrid;
using MagalitiIdentityServer.Shared.Configuration.Email;
using MagalitiIdentityServer.Shared.Email;
using MagalitiIdentityServer.STS.Identity.Configuration;
using MagalitiIdentityServer.STS.Identity.Configuration.ApplicationParts;
using MagalitiIdentityServer.STS.Identity.Configuration.Constants;
using MagalitiIdentityServer.STS.Identity.Configuration.Interfaces;
using MagalitiIdentityServer.STS.Identity.Helpers.Localization;
using System.Linq;
using IdentityServer4;
using Microsoft.AspNetCore.Authentication.AzureAD.UI;
using Microsoft.AspNetCore.Authentication.OAuth;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using MagalitiIdentityServer.Admin.EntityFramework.MySql.Extensions;
using MagalitiIdentityServer.Admin.EntityFramework.PostgreSQL.Extensions;
using MagalitiIdentityServer.Admin.EntityFramework.Shared.Configuration;
using MagalitiIdentityServer.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Microsoft.IdentityModel.Tokens;
using MagalitiIdentityServer.Shared.Authentication;
using MagalitiIdentityServer.Shared.Configuration.Identity;

namespace MagalitiIdentityServer.STS.Identity.Helpers
{
