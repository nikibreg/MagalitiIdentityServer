...
using MagalitiIdentityServer.Admin.Api.Dtos.Roles;
using MagalitiIdentityServer.Admin.Api.Dtos.Users;
using MagalitiIdentityServer.Admin.Api.ExceptionHandling;
using MagalitiIdentityServer.Admin.Api.Helpers.Localization;
using MagalitiIdentityServer.Admin.Api.Resources;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Services.Interfaces;

namespace MagalitiIdentityServer.Admin.Api.Controllers
{
